 ...
 * <p/>
 * The extracted features include the duration in seconds, the duration normalized by the duration
 * of surrounding words, and the length and presence of any following silences. <p/>
 * TODO: This behavior should almost certainly be refactored into a broader set of feature
 * extractors
 */
public class DurationFeatureExtractor extends FeatureExtractor {
  public static final String moniker =
      "duration,prevPause,follPause,nominal_followsSilence,nominal_precedesSilence";
