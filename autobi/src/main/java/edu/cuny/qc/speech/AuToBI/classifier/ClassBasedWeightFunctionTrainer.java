...
/**
 * Created by IntelliJ IDEA. User: andrew Date: 3/3/12 Time: 10:46 AM To change this template use
...
public class ClassBasedWeightFunctionTrainer {
  ...
  public static Map<String, Double> getClassWeightMapping(
      List<Word> regions, String class_attribute, WeightType type) {
