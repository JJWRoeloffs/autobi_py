...
/**
 * PitchAccentClassificationFeatureSet is responsible for describing the features necessary to
 * perform pitch accent classification.
 */
    ...
    for (String acoustic :
      ...
      for (String slope : new String[] {"", "delta"}) {
        for (String agg : new String[] {"max", "mean", "min", "stdev", "zMax", "cog", "area",
          ...
          String psylf = AuToBIUtils.makeFeatureName(agg,
              AuToBIUtils.makeFeatureName(
                  "subregionC", AuToBIUtils.makeFeatureName(slope, acoustic), "psyl"));
