 ...
 * trained. During evaluation, each of the k classifiers generate hypotheses, which are combined
...
public class MinimumClassEnsembleSampledClassifier extends EnsembleSampledClassifier {
  ...
  public List<FeatureSet> constructEnsembleFeatureSets(FeatureSet training_set) {
    ...
    try {
      PartitionUtils.assignStratifiedFoldNum(training_set.getDataPoints(), "ensemble_sampling_fold",
          num_folds, training_set.getClassAttribute());
