 ...
 * <p/>
 * The standard ResetContourFeatureExtractor extract reset features from the full regions.  This
 * extends this functionality to identify reset over narrower regions. <p/> While developed as a
 * utility for subregions, this can operate on regions longer than the initial region.  For example,
...
public class SubregionResetFeatureExtractor extends FeatureExtractor {
   ...
   * <p/>
   * Subregions are described as a number of seconds "2s" or milliseconds "50ms".  Other names will
   * raise an exception
   *
