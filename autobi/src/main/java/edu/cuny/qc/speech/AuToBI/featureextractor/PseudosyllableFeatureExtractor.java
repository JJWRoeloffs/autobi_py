...
/**
 * PseudosyllableFeatureExtractor hypothesizes syllables for a given signal and aligns the loudest
 * contained syllable to each region. <p/> These pseudosyllables are generated by Syllabifier, and
 * are stored as SubWord features on the regions.
 *
 * @see Syllabifier
