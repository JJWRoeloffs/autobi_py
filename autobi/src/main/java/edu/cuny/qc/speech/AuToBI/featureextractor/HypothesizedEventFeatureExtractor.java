...
/**
 * HypothesizedEventFeatureExtractor is used to drive the AuToBI hypothesis generation through the
 * FeatureExtractor interface.    This allows the feature reference counting structure to be
...
public class HypothesizedEventFeatureExtractor extends FeatureExtractor {
   ...
   */
  public HypothesizedEventFeatureExtractor(
      String hyp_feature, AuToBIClassifier classifier, FeatureSet fs) {
