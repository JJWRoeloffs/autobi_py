...
public class ClassWeightedWekaClassifier extends WekaClassifier {
  ...
  public void train(FeatureSet feature_set) throws Exception {
    ...
    ClassBasedWeightFunctionTrainer trainer = new ClassBasedWeightFunctionTrainer(
    ...
    Instances weka_instances =
        ClassifierUtils.convertFeatureSetToWeightedWekaInstances(feature_set, fn);
