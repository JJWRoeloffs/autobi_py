...
/**
 * NegativeSymmetricList is a wrapper around an ArrayList<Double> that is symmetric for positive and
 * negative indices. <p/> This allows for retrieval of negative indices, since they are the same as
 * the corresponding positive index. <p/> This could also be accomplished using
 * ArrayList.get(Math.abs(i)).
 */
