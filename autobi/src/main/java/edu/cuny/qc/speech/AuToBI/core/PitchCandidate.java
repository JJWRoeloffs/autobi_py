...
/**
 * A single hypothesized PitchCandidate stores the frequency and the strengths of a hypothesis.  The
 * strengths can be understood as the confidence of the pitch hypothesis.
 */
