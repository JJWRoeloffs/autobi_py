...
/**
 * SpectrumPADFeatureExtractor is a FeatureExtractor which generates hypothesized pitch accent
 * detection (PAD) prediction hypotheses given a particular spectral region. <p/> This feature
 * extractor requires the association of an externally trained pitch accent detection classifier and
 * a descriptor of the spectral region -- here typically in terms of a low and high bark boundary.
 * <p/>
...
public class SpectrumPADFeatureExtractor extends FeatureExtractor {
   ...
   */
  public SpectrumPADFeatureExtractor(
