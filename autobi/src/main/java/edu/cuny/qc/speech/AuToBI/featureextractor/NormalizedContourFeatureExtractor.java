 ...
 * performed using z-score normalization ((x-mean) / stdev) based on a supplied
      ...
      if (r.hasAttribute(feature_name) && r.hasAttribute(norm_feature)) {
        ...
        if (cache.containsKey(c)) {
          ...
          if (norm_params.canNormalize(feature_name)) {
            Contour norm_contour = ContourUtils.zScoreNormalizeContour(
                (Contour) r.getAttribute(feature_name), norm_params, feature_name);
