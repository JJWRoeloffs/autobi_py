...
/**
 * PitchAccentDetectionClassifierCollection contains and serializes the ensemble of classifiers that
 * are used in corrected energy based pitch accent detection. <p/> This collection includes a set of
 * pitch accent detection models, each of which is trained on a distinct frequency band of the
 * signal's spectum, and a second set of correction models resposible for correcting the hypotheses
...
public class PitchAccentDetectionClassifierCollection implements Serializable {
  ...
  /**
   * Sets a correction classifier for a pitch accent detector trained on a specific frequency
   * region.
   *
   * @param low        the low frequency (usually in bark)
   * @param high       the high frequency
  ...
  /**
   * Gets a correction classifier for a pitch accent detector trained on a specific frequency
   * region.
   *
   * @param low  the low frequency (usually in bark)
   * @param high the high frequency
