...
/**
 * IntermediatePhraseBoundaryFeatureExtractor is a FeatureExtractor that is responsible for
 * extracting ground truth labels for whether or not a word boundary is an intermediate phrase
 * boundary.
 */
