...
public class AuToBIUtilsTest {
  ...
  // This test uses globs, which is hard to monitor with the proper resource management
  // @Test
  ...
  //   try {
  //     AuToBIUtils.globSingleFile(ResourcePath.getResourcePath("FALSE_FILENAME.wav"));
  //     fail();
  //   } catch (AuToBIException e) {
  //     // Expected.
  //   }
