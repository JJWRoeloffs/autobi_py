...
public class SNPAssignmentFeatureExtractorTest {
  ...
  public void assignsDefaultFeatureOnNullSpeakerID() {
    try {
      String test_file = ResourcePath.getResourcePath("h1.spkrnorm");
  ...
  public void assignsFeatures() {
    try {
      ArrayList<String> files = new ArrayList<String>();
      files.add(ResourcePath.getResourcePath("h1.spkrnorm"));
      files.add(ResourcePath.getResourcePath("h2.spkrnorm"));
