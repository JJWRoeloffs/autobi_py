...
public class ClassifierUtilsTest {
  ...
  public void ReadClassifier() {
    String filename = ResourcePath.getResourcePath("test.model");
  ...
  public void testWriteClassifierExecutesWithoutError() {
    String filename = ResourcePath.getResourcePath("testwrite.model");
  ...
  public void ReadClassifierNotAClassifier() {
    String filename = ResourcePath.getResourcePath("sineWithNoise.wav");
