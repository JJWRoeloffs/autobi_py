...
public class CurveShapeFeatureExtractorTest {
  ...
  public void testExtractFeatureRisingContourWorks() {
    ...
    try {
      ...
      assertArrayEquals(
          new double[] {0., 1., 1., 2., 9., 9., 9., 9., 9., 9.}, rising.smoothed_curve, 0.001);
  ...
  public void testExtractFeatureFallingContourWorks() {
    ...
    try {
      ...
      CurveShape falling = (CurveShape) regions.get(0).getAttribute("fallingCurve[contour]");
      assertEquals(-1, falling.peak);
      assertArrayEquals(new double[] {6.3333, 6.3333, 6.3333, 6.3333, 6.3333, 6.3333, 6.3333,
                            6.3333, 6.3333, 1.0},
  ...
  public void testExtractFeaturePeakContourWorks() {
    ...
    try {
      ...
      CurveShape peak = (CurveShape) regions.get(0).getAttribute("peakCurve[contour]");
      assertEquals(8, peak.peak);
      assertArrayEquals(
          new double[] {0., 1., 1., 2., 10., 10, 10., 11., 12., 1.}, peak.smoothed_curve, 0.001);
  ...
  public void testExtractFeatureValleyContourWorks() {
    ...
    try {
      ...
      CurveShape valley = (CurveShape) regions.get(0).getAttribute("valleyCurve[contour]");
